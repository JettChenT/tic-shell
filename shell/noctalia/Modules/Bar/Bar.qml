...
Item {
  ...
  readonly property real barThickness: barIsVertical ? Style.getBarThicknessForScreen(screen?.name) : barHeight
  ...
  Loader {
    ...
    sourceComponent: Item {
      ...
      Item {
        ...
        x: (root.barPosition === "right") ? (parent.width - root.barThickness) : 0
        y: (root.barPosition === "bottom") ? (parent.height - root.barHeight) : 0
        width: root.barIsVertical ? root.barThickness : parent.width
