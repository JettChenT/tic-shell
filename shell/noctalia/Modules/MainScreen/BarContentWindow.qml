...
PanelWindow {
  ...
  readonly property real barThickness: Style.getBarThicknessForScreen(barWindow.screen?.name)
  ...
  implicitWidth: barIsVertical ? barThickness : barWindow.screen.width
